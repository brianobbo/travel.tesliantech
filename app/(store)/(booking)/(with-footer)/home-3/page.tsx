...
const HomePage = async () => {
  ...
  const services = await categoryService.getAll({ lang, type: "service", perPage: 11 });
  const shops = await shopService.getAll({ lang, perPage: 8 });
      ...
      <main>
        ...
        <section className="my-10">
          ...
          <div className="xl:container pb-12">
            <Stories suspense buttonVariant="2" />
          </div>
        </section>

...
export const MarkerCluster = ({ centerLatitude, centerLongitude }: MarkerClusterProps) => {
  ...
  const { data: shops } = useInfiniteQuery(
    [
      ...
      urlSearchParams.get("categoryId"),
      urlSearchParams.get("take"),
    ...
    () =>
      shopService.getAll({
        ...
        service_min_price: debouncePriceFrom,
        service_max_price: debouncePriceTo,
        has_discount: urlSearchParams.has("has_discount") ? urlSearchParams.get("has_discount") : 0,
        category_id: urlSearchParams.get("categoryId"),
        take: urlSearchParams.get("take"),

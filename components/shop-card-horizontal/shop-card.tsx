        ...
        >
          ...
          <div className="flex flex-col justify-between gap-3  flex-1">
            <div className="flex items-center justify-between">
              <div>
                <strong className="text-lg font-semibold mt-7 ">{data.translation?.title}</strong>
                <span className="text-sm text-gray-field line-clamp-2">
                  {data.translation?.description}
                </span>
              </div>
              <div className="rounded-full relative w-10 h-10 flex items-center justify-center z-[1] aspect-square">
                <Image
                  src={data.logo_img}
